...
with tab4:
    ...
    if len(type_trend) > 0:
        ...
        国产品牌在{"破3精英选手" if cohort_filter == "破3选手" else "全局跑者"}群体中{competition_text}，
        特步、必迈等品牌凭借碳板跑鞋技术突破，{challenge_text}国际品牌的市场垄断。<br><br>
...
st.markdown("---")
st.markdown(
    '<div style="text-align:center;color:#64748B;padding:1rem;">📊 马拉松跑鞋品牌分析平台 v2.0 | 数据来源：悦跑圈等平台</div>',
    unsafe_allow_html=True,
)
